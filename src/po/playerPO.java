...
public class playerPO implements Serializable{
	...
	private ArrayList<playerInSingleMatchPO> recentFive=new ArrayList<playerInSingleMatchPO>();
	...
	public void setRecentFive(ArrayList<playerInSingleMatchPO> recentFive){
		this.recentFive=recentFive;
	}
	public ArrayList<playerInSingleMatchPO> getRecentFive(){
		return recentFive;
	}
